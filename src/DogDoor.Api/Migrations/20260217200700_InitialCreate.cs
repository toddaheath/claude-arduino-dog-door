        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoCloseDelaySeconds = table.Column<int>(type: "integer", nullable: false),
                    MinConfidenceThreshold = table.Column<double>(type: "double precision", nullable: false),
                    NightModeEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NightModeStart = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    NightModeEnd = table.Column<TimeOnly>(type: "time without time zone", nullable: true),
                    ApiKey = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoorConfigurations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoorConfigurations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGuests", x => new { x.OwnerId, x.GuestId });
                    table.ForeignKey(
                        name: "FK_UserGuests_Users_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGuests_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoorEvents_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_DoorEvents_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoorConfigurations_UserId",
                table: "DoorConfigurations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DoorEvents_AnimalId",
                table: "DoorEvents",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_DoorEvents_Direction",
                table: "DoorEvents",
                column: "Direction");

            migrationBuilder.CreateIndex(
                name: "IX_DoorEvents_EventType",
                table: "DoorEvents",
                column: "EventType");

            migrationBuilder.CreateIndex(
                name: "IX_DoorEvents_Timestamp",
                table: "DoorEvents",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_DoorEvents_UserId",
                table: "DoorEvents",
                column: "UserId");
